...
/**
 * REST controller for managing {@link com.okokbatonmanioc.com.domain.Client}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ClientResource {
    ...
    public ResponseEntity<Client> partialUpdateClient(
        ...
        Optional<Client> result = clientRepository
            ...
            .map(existingClient -> {
                if (client.getIdC() != null) {
                    existingClient.setIdC(client.getIdC());
                }
                if (client.getFirstNameC() != null) {
                    existingClient.setFirstNameC(client.getFirstNameC());
                }
                if (client.getLastNameC() != null) {
                    existingClient.setLastNameC(client.getLastNameC());
                }
                if (client.getEmail() != null) {
                    existingClient.setEmail(client.getEmail());
                }
                if (client.getPhoneNumberC() != null) {
                    existingClient.setPhoneNumberC(client.getPhoneNumberC());
                }
