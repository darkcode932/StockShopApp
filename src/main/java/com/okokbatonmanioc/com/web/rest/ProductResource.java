...
import com.okokbatonmanioc.com.repository.ProductRepository;
...
/**
 * REST controller for managing {@link com.okokbatonmanioc.com.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductResource {
    ...
    public ResponseEntity<Product> partialUpdateProduct(
        ...
        Optional<Product> result = productRepository
            ...
            .map(existingProduct -> {
                if (product.getIdP() != null) {
                    existingProduct.setIdP(product.getIdP());
                }
                ...
                if (product.getRetentionDate() != null) {
                    existingProduct.setRetentionDate(product.getRetentionDate());
                }
