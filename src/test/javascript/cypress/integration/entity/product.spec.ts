...
describe('Product e2e test', () => {
  ...
  it('should create an instance of Product', () => {
    ...
    cy.get(`[data-cy="idP"]`).type('Rustic Tasty').should('have.value', 'Rustic Tasty');

    cy.get(`[data-cy="title"]`).type('stable la').should('have.value', 'stable la');

    cy.get(`[data-cy="type"]`).type('Buckinghamshire Bourgogne Visionary').should('have.value', 'Buckinghamshire Bourgogne Visionary');

    cy.get(`[data-cy="retentionDate"]`).type('2021-09-27T12:52').should('have.value', '2021-09-27T12:52');

    cy.get(`[data-cy="description"]`).type('c a').should('have.value', 'c a');
