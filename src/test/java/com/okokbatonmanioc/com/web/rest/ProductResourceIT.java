...
class ProductResourceIT {
    ...
    private static final String DEFAULT_ID_P = "AAAAAAAAAA";
    private static final String UPDATED_ID_P = "BBBBBBBBBB";
    ...
    private static final Instant DEFAULT_RETENTION_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_RETENTION_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .title(DEFAULT_TITLE)
            .type(DEFAULT_TYPE)
            .retentionDate(DEFAULT_RETENTION_DATE)
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product()
            ...
            .title(UPDATED_TITLE)
            .type(UPDATED_TYPE)
            .retentionDate(UPDATED_RETENTION_DATE)
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getIdP()).isEqualTo(DEFAULT_ID_P);
        assertThat(testProduct.getTitle()).isEqualTo(DEFAULT_TITLE);
        assertThat(testProduct.getType()).isEqualTo(DEFAULT_TYPE);
        assertThat(testProduct.getRetentionDate()).isEqualTo(DEFAULT_RETENTION_DATE);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].retentionDate").value(hasItem(DEFAULT_RETENTION_DATE.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.retentionDate").value(DEFAULT_RETENTION_DATE.toString()))
    ...
    void putNewProduct() throws Exception {
        ...
        Product testProduct = productList.get(productList.size() - 1);
        assertThat(testProduct.getIdP()).isEqualTo(UPDATED_ID_P);
        assertThat(testProduct.getTitle()).isEqualTo(UPDATED_TITLE);
        assertThat(testProduct.getType()).isEqualTo(UPDATED_TYPE);
        assertThat(testProduct.getRetentionDate()).isEqualTo(UPDATED_RETENTION_DATE);
